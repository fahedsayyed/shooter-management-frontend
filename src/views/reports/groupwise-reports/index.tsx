...
import { IGroupwiseReport } from "src/types/Reports";
import CustomFormLabel from "src/utils/theme-elements/CustomFormLabel";
import CustomRadio from "src/utils/theme-elements/CustomRadio";

function CustomTabPanel(props: IGroupwiseReport) {
...
const GroupwiseReport = () => {
  ...
  return (
    <BlankCard>
      <TableHead title="Groupwise Reports" />
        ...
        <Grid item xs={12}>
          <Box sx={{ borderBottom: 1, borderColor: "divider", paddinBottom: "10px", mt: 1 }}>
            <Tabs value={value} onChange={handelTab} sx={{ height: "40px" }} aria-label="basic tabs example">
              <Tab label="Groupwise entries report " {...a11yProps(0)} />
              <Tab label="Groupwise shooter report" {...a11yProps(1)} />
              <Tab label="Targetwise shooter report" {...a11yProps(2)} />
            </Tabs>
          </Box>
