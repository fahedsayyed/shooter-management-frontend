...
const AthleteCompetitionDashboards = () => {
            ...
            <Grid item xs={6} sm={4} md={3} key={dashlinks.id}>
              <BlankCard>
                <CardContent sx={{ cursor: 'pointer' }}>
                  <Link style={{ color: '#000' }} to={`${APP_ROUTES.ATHLETE_COMPETITION}/dashboard-links/${routeName}${dashlinks.route}`}>
...
export default AthleteCompetitionDashboards