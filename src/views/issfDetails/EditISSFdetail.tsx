...
function EditISSFdetail() {
  const [action, setAction] = useState<IIssfDetails>({
    id: 0,
    shooterId: "",
    shootername: "",
    rank: "",
  ...
  return (
    <>
      <BackLink title="Back to the ISSF Details page" route={APP_ROUTES.ISSF_DETAILS} />
