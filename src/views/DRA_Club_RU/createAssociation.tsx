...
import { Button, CardContent, FormControl, FormHelperText, Grid, Paper } from "@mui/material";
  ...
  return (
    <PageContainer>
      ...
      <Paper style={{ padding: "0px", marginTop: "0px" }}>
        <TableHead title="Add Rifle Club/District Rifle Association/Registered Unit" />
        <Grid item xs={12}>
          <CardContent>
