...
function ViewMatchParticipation() {
  ...
  // Add a serial number to each item in the matchParticipationDetailList
  const matchParticipationDetailListWithSerial = matchParticipationDetailList.map((item: any, index: any) => ({
    ...item,
    id: index + 1,
  }));

  // Use a Set to store unique combinations of first_name and last_name
...
export default ViewMatchParticipation;
