...
import { setLocalFormData, getLocalFormData } from "src/services/localStorage/localServices";
...
const FormSlideOne = () => {
  ...
  const initialFormData = getLocalFormData("slideOneFormData") || {
    stateUnit: "UTTARAKHAND",
    firstName: "",
    lastName: "",
    mainEvent: "rifle",
    // playingEvents: [],
  ...
  useEffect(() => {
    const { profilePhoto, birthProof, actionPhoto, ...restData } = formData;
    setLocalFormData("slideOneFormData", restData);
    updateFormData();
  }, [formData, dispatch]);
        ...
        <Grid container columnSpacing={3} marginTop={2}>
          <Grid item xs={12} md={6}>
            <FormControl error={!!error.stateUnit} fullWidth>
              <CustomFormLabel sx={{ mt: 0 }} htmlFor="state-unit-text">
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <CustomCheckbox
                        ...
                        name="playingEvents"
                        value={weapon}
                        checked={formData.playingEvents[weapon] === true}
                        onChange={handleChange}
                      />
                    }
          ...
          <Grid item xs={12} md={6}>
            <CustomFormLabel htmlFor="bi-education"> Education </CustomFormLabel>
            <CustomTextField
              startadornment={
                <InputAdornment position="start">
          ...
          <Grid item xs={12} md={6}>
            <FileUpload title="Birth Proof" required={true} onFileUpload={handleBirthProofUpload} />
            {/* <FormHelperText>"BIrth proof is a required field"</FormHelperText> */}
          </Grid>
          <Grid item xs={12} md={6}>
            <FileUpload title="Action picture" required={false} onFileUpload={handleActionPhotoUpload} />
          </Grid>
