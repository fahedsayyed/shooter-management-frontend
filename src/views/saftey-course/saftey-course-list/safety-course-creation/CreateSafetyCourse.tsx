...
const CreateSafetyCourse = () => {
  ...
  return (
    <>
      ...
      <BlankCard>
      <TableHead title="Safety Course Creation" />
        <Grid container columnSpacing={2} padding={2}>
          <Grid item xs={12} md={6} lg={4}>
            <FormControl fullWidth>
              <CustomFormLabel>Name <RequiredStar /> </CustomFormLabel>
              <CustomTextField
                id="name"
          ...
          <Grid item xs={12} md={6} lg={4}>
          <FormControl fullWidth>
              <CustomFormLabel>Day of safety course <RequiredStar /> </CustomFormLabel>
              <CustomTextField
                id="name"
          ...
          <Grid item xs={12} md={6} lg={4}>
          <FormControl fullWidth>
              <CustomFormLabel>Limit <RequiredStar /> </CustomFormLabel>
              <CustomTextField
                id="name"
          ...
          <Grid item xs={12} md={6} lg={4}>
          <FormControl fullWidth>
              <CustomFormLabel>Registration Start date <RequiredStar /> </CustomFormLabel>
              <CustomTextField
                id=""
                type='date'
          ...
          <Grid item xs={12} md={6} lg={4}>
          <FormControl fullWidth>
              <CustomFormLabel>Registration end date <RequiredStar /> </CustomFormLabel>
              <CustomTextField
                id=""
                type='date'
...
export default CreateSafetyCourse;
